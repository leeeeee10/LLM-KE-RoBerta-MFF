...
model_path = r"lora_rag_LLM/DeepSeek-R1-Distill-Qwen-1.5B"#模型路径(换成自己存放模型的路径)
...
dataset = load_dataset(
    "json",
    data_files={"train":"lora_rag_LLM/datasets.jsonl"},  # 直接指定文件路径
    split="train"
)
print(len(dataset))
...
training_args = TrainingArguments(
    output_dir="lora_rag_LLM/final_models",
    num_train_epochs=10,
...
save_path="lora_rag_LLM/saved_models"
